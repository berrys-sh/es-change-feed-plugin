...
public class ConfigurationManager {
    ...
    private final Logger log = Loggers.getLogger(ConfigurationManager.class, "Changes Feed");
            ...
            InputStream input = java.security.AccessController.doPrivileged((PrivilegedAction<InputStream>) new PrivilegedAction<InputStream>() {
                ...
                public InputStream run() {
                    try {
                        ...
                        return new FileInputStream(Paths.get(".").toAbsolutePath().normalize().toString() + "/plugins/es-change-feed-plugin/plugin-config.properties");
